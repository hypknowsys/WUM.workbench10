...
REM
REM After setting the following two environment variables, WUMbatch -- the
REM command line batch script processor of the WUM Workbench -- can be
...
REM
REM prompt% wumbatch.bat <WUM Batch Script File Name> verbose
REM
...
REM \data, \doc and \lib. The environment variable WUM_HOME must be
REM adjusted according to the installation of the WUM Workbench.
REM Example: SET WUM_HOME=C:\WUM.workbench10
REM
...
REM pif-file to start the WUM Workbench by double-clicking on its icon.
